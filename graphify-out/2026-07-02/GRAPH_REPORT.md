...
## Corpus Check
- 494 files · ~827,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3076 nodes · 6138 edges · 304 communities (234 shown, 70 thin omitted)
...
Cohesion: 0.06
Nodes (78): generar_pdf_inscripcion(), Genera comprobante de inscripción en PDF con ReportLab., AlumnoAdmin, RepresentanteAdmin, Alumno, AlumnoManager, AlumnoManagerCompleto, BienNacional (+70 more)
...
Cohesion: 0.15
Nodes (12): annotate_en_mora(), annotate_mora_detalle(), _condicion_mora(), estatus_financiero_actual(), _hoy(), Fuente de verdad ÚNICA para el cálculo de morosidad.  Antes existían dos criteri, Estado a mostrar para un Alumno que ya trae la anotación `en_mora`.     Conserva, Devuelve (deuda_mes_pasado, deuda_mes_actual) como expresiones para anotar     s (+4 more)
...
Cohesion: 0.10
Nodes (15): FULL_HEIGHT_PAGES, MainLayout(), PAGE_TITLES, SedeSwitcher(), navSections, Sidebar(), AuthProvider(), AuthContext (+7 more)
...
Cohesion: 0.22
Nodes (9): SmartDateInput(), useAuditoria(), Auditoria(), AuditoriaKPIs(), AuditoriaTabla(), KPI_CONFIG, badgeClass(), fmt() (+1 more)

### Community 26 - "useDashboardStats"
Cohesion: 0.06
Nodes (29): getDashboardStats(), DashboardSkeleton(), DonutChart, KpiCard, StackedBar, useDashboardStats(), useMultiSedeDashboard(), useSedeDetalle() (+21 more)
...
Cohesion: 0.09
Nodes (23): ModalAjustarMensualidades(), ModalAsignarGrado(), ModalConfirmarReactivar(), inputStyle, ModalEditarAlumno(), inputStyle, ModalRegistrarAlumno(), ModalRetirar() (+15 more)
...
Cohesion: 0.11
Nodes (14): asignarUsuarioSede(), createSede(), deleteSede(), getDashboardConsolidado(), getDashboardSede(), getSedes(), getUsuariosSede(), revocarUsuarioSede() (+6 more)
...
## Knowledge Gaps
- **476 isolated node(s):** `deploy.sh script`, `Migration`, `Migration`, `Migration`, `Migration` (+471 more)
...
- **Why does `apiClient` connect `useBancosCobranza` to `calcDefinitiva`, `nombreGradoCompleto`, `DatePickerES`, `calcAVEC`, `useRepresentantes`, `Community 78`, `useUsuariosSistemas`, `useAuditoria`, `Community 84`, `Comprobantes`, `useConfiguracionNotificaciones`, `useDashboardStats`, `useInscripcion`?**
