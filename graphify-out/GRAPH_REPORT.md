...
## Corpus Check
- 500 files · ~831,791 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3162 nodes · 6363 edges · 315 communities (244 shown, 71 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 1482 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9f2c882`
...
7. `ConfiguracionSistema` - 42 edges
8. `Representante` - 42 edges
9. `Nota` - 41 edges
10. `Mensualidad` - 41 edges
...
Cohesion: 0.05
Nodes (86): estatus_financiero_actual(), Estado a mostrar para un Alumno que ya trae la anotación `en_mora`.     Conserva, generar_pdf_inscripcion(), Genera comprobante de inscripción en PDF con ReportLab., AlumnoAdmin, RepresentanteAdmin, Alumno, AlumnoManager (+78 more)
...
Cohesion: 0.14
Nodes (14): calcSueldoBase(), calcMontoNomina(), inputStyle, labelStyle, Pagos(), PERIODOS, TABS_CESTA, TIPO_LABEL (+6 more)
...
Cohesion: 0.20
Nodes (47): APIView, ExcelExporter, Utilidad global para exportar QuerySets a formato Excel (.xlsx) nativo., MensualidadFilter, PagoFilter, Filtros avanzados para el modelo Mensualidad.      Query params disponibles:, Filtros avanzados para el modelo Pago.      Query params disponibles:       - al, BancoInstitucional (+39 more)
...
Cohesion: 0.16
Nodes (12): buildCategoriasDefault(), calcAVEC(), calcPrimaAntiguedad(), calcPrimaPostgrado(), CESTA_DEFAULT, EMPTY_EMP, loadCestaConfig(), POSTGRADO_PCT (+4 more)
...
Cohesion: 0.15
Nodes (12): FULL_HEIGHT_PAGES, MainLayout(), PAGE_TITLES, SedeSwitcher(), navSections, Sidebar(), useSede(), useMorosos() (+4 more)

### Community 20 - "useBancosCobranza"
Cohesion: 0.12
Nodes (9): apiClient, failedQueue, activarPortalRepresentante(), desactivarPortalRepresentante(), restablecerContrasenaPortal(), tokenStore, AuthContext, SedeContext (+1 more)
...
Cohesion: 0.10
Nodes (18): ModalAjustarMensualidades(), ModalAsignarGrado(), ModalConfirmarReactivar(), inputStyle, ModalEditarAlumno(), inputStyle, ModalRegistrarAlumno(), ModalRetirar() (+10 more)
...
Cohesion: 0.06
Nodes (37): Meta, Normaliza una referencia bancaria para comparación uniforme:         elimina esp, Lógica unificada de guardado: Generación de referencia para efectivo,         va, annotate_en_mora(), annotate_mora_detalle(), _condicion_mora(), _hoy(), Fuente de verdad ÚNICA para el cálculo de morosidad.  Antes existían dos criteri (+29 more)
...
Cohesion: 0.23
Nodes (13): EMPTY_RECIBO, fmtBs(), DocenteBanner(), inputStyle, labelStyle, MonthInput, ReciboModal(), _buildReciboAVECDoc() (+5 more)
...
Cohesion: 0.15
Nodes (11): useRepresentantes(), INPUT_STYLE, Representantes(), ERR_STYLE, INPUT_STYLE, LABEL_STYLE, ModalRepresentante(), CONTACTO_FIELDS (+3 more)
...
Cohesion: 0.09
Nodes (19): CierreCaja, CierreCajaSerializer, ComprobanteSerializer, DesglosePagoSerializer, Meta, PagoItemSerializer, Esquema estricto para cada método de pago dentro de una transacción., Devuelve el nombre completo del representante.         Primero intenta obtenerl (+11 more)
...
Cohesion: 0.06
Nodes (33): Meta, Mensualidad, generar_mensualidades(), generar_mensualidades_alumno_periodo(), mes_en_periodo_lectivo(), meses_periodo_escolar(), monto_mensualidad_defecto(), parsear_periodo_escolar() (+25 more)
...
Cohesion: 0.20
Nodes (10): useBancosCobranza(), useBancosNomina(), useConfiguracion(), useGrados(), useInstitucionPDF(), useLogosRecibo(), useNotificaciones(), useTiposCargo() (+2 more)

### Community 312 - "Community 312"
Cohesion: 0.39
Nodes (5): useNomina(), useSyncedLocalStorage(), SkeletonFila(), Nomina(), TABS
...
- **Why does `apiClient` connect `useBancosCobranza` to `nombreGradoCompleto`, `DatePickerES`, `calcAVEC`, `Community 78`, `useUsuariosSistemas`, `Community 113`, `useAlumnos`, `useAuditoria`, `Community 84`, `Comprobantes`, `Community 119`, `useDashboardStats`, `Community 311`, `useInscripcion`?**
