...
## Corpus Check
- 897 files · ~1,125,706 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6598 nodes · 19317 edges · 483 communities (362 shown, 121 thin omitted)
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 7864 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `478a6663`
...
## Communities (483 total, 121 thin omitted)
...
Cohesion: 0.05
Nodes (52): buildCategoriasDefault(), calcAVEC(), calcPrimaAntiguedad(), calcPrimaPostgrado(), calcSueldoBase(), CATEGORIAS_DOCENTE, CESTA_DEFAULT, EMPTY_EMP (+44 more)
...
Cohesion: 0.15
Nodes (95): PdfSinTablaError, El PDF no tiene tablas/texto extraíble (ej. es un escaneo/imagen)., ExcelExporter, Utilidad global para exportar QuerySets a formato Excel (.xlsx) nativo., MensualidadFilter, PagoFilter, Filtros avanzados para el modelo Mensualidad.      Query params disponibles:, Filtros avanzados para el modelo Pago.      Query params disponibles:       - (+87 more)
...
Cohesion: 0.03
Nodes (67): alumnos_de_pago(), calcular_datos_administrativos_inscripcion(), configuracion_activa(), generar_mensualidades(), mes_en_periodo_lectivo(), meses_ano_escolar(), monto_con_beca(), monto_mensualidad_defecto() (+59 more)
...
Cohesion: 0.05
Nodes (28): DashboardSkeleton(), DonutChart, KpiCard, StackedBar, useRepresentantes(), CLASIFICACION_COLORS, CONCEPTOS, ESTATUS (+20 more)

### Community 20 - "useBancosCobranza"
Cohesion: 0.04
Nodes (36): getBoletin(), apiClient, failedQueue, exportarMorososExcel(), getLecturasCircular(), activarPortalRepresentante(), desactivarPortalRepresentante(), restablecerContrasenaPortal() (+28 more)
...
Cohesion: 0.07
Nodes (26): SidebarFichaAlumno(), COLUMNAS, TablaAlumnos(), TablaAlumnosSkeleton(), useBoletin(), nombreGradoCompleto(), NOMBRES_GRADO, ORDEN_GRADO (+18 more)
...
Cohesion: 0.04
Nodes (71): ModalAjustarInscripcion(), ModalAjustarMensualidades(), ModalAsignarGrado(), ModalConfirmarQuitarGrado(), ModalConfirmarReactivar(), ESTATUS_FINANCIERO_LABELS, inputStyle, ModalEditarAlumno() (+63 more)
...
Cohesion: 0.05
Nodes (41): buscarRepresentante(), crearInscripcion(), descargarComprobanteBlob(), fetchAlumnosPorRepresentante(), fetchConfiguracionInscripcion(), listarInscripciones(), subirFotoAlumno(), SmartDateInput() (+33 more)

### Community 32 - "useInstitucionPDF"
Cohesion: 0.11
Nodes (10): getRendimientoAlumnoPortal(), SaldoTarjetaCard(), SkeletonCard(), usePortalHeroExtra(), usePortalPerfil(), PortalPerfil(), WidgetHeroPortal(), WidgetProximosVencimientos() (+2 more)

### Community 33 - "useLapsos"
Cohesion: 0.18
Nodes (8): Meta, PerfilUsuario, validar_tamano_adjunto(), Meta, PerfilFotoSerializer, PerfilSerializer, Validación del archivo de foto de perfil (tamaño/tipo) antes de guardarlo., Migration
...
Cohesion: 0.22
Nodes (7): getDashboardStats(), useDashboardStats(), CARDS(), MorososSummary(), MorososList(), Dashboard(), fmt()
...
Cohesion: 0.07
Nodes (31): BloqueDeudaAlumno(), CobranzaStep1(), CobranzaStep2(), CONCEPTOS, METODOS_PAGO, DecimalInput(), ResumenPago(), Cobranza() (+23 more)
...
Cohesion: 0.05
Nodes (25): AdminComprobantesTests, asignar_rol(), ConfiguracionColegioPublicaCacheTest, crear_alumno(), crear_mensualidad(), crear_representante_con_portal(), PortalDashboardNPlusOneTest, PortalDashboardTests (+17 more)
...
Cohesion: 0.04
Nodes (43): CantinaLayout(), NAV_ITEMS, ROL_LABELS, ROLES_CANTINA, ConfirmDeleteModal(), ProtectedRoute(), SedeSwitcher(), ACENTOS (+35 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (25): annotate_en_mora(), annotate_mora_detalle(), calcular_dias_atraso(), _condicion_mora(), estatus_financiero_actual(), _hoy(), Fuente de verdad ÚNICA para el cálculo de morosidad.  Antes existían dos crite, Anota `en_mora` (BooleanField) sobre un queryset de Alumno según el criterio (+17 more)
...
Cohesion: 0.06
Nodes (35): RegistroNominaAdmin, actualizar_nominas_por_cambio_maestro(), ConceptoNomina, Empleado, Meta, ParametroLegalNomina, Lógica según ley venezolana utilizando redondeo matemático seguro (.quantize)., Redondeo comercial (0.005 siempre sube), no el ROUND_HALF_EVEN por defecto de De (+27 more)
...
Cohesion: 0.04
Nodes (75): validar_tamano_adjunto(), CuotaSolvenciaAdmin, anular_pago(), cargar_pago_retroactivo(), corregir_pago(), fecha_dentro_periodo_activo(), fecha_en_cierre_validado(), Módulo "Corrección de Pagos".  Tres flujos de negocio relacionados pero distinto (+67 more)

### Community 80 - "Community 80"
Cohesion: 0.10
Nodes (20): ASSETS — BARRA SUPERIOR (acabado visual + símbolo de marca), BACKEND — GENERACIÓN AUTOMÁTICA DE MENSUALIDADES (2026-07-02), BUG — INSCRIPCIONES PERMITIDAS CON PERÍODO CERRADO (2026-07-10), CHECKLIST, COMPROBANTE DE INSCRIPCIÓN — PAGOS FUERA DE TRANSFERENCIA/EFECTIVO NO APARECÍAN (2026-07-22), CONTACTO DE EMERGENCIA = DATOS DEL REPRESENTANTE (2026-07-10), ELIMINAR REPRESENTANTE — SOFT DELETE EN CASCADA (2026-07-11), FASE 0 — HOUSEKEEPING (2026-07-27) (+12 more)
...
Cohesion: 0.05
Nodes (35): actualizarDocente(), asignarMateriasDocente(), crearDocente(), createLapso(), createMateria(), deleteHorario(), deleteLapso(), deleteMateria() (+27 more)
...
Cohesion: 0.20
Nodes (4): getDashboardSede(), useSedeDetalle(), PagosTable(), SedeDetalle()
...
Cohesion: 0.27
Nodes (6): CircularLecturasModal(), Cards(), ESTADO_DEFAULT, ESTADO_STYLE, Tabla(), fmtFecha()
...
Cohesion: 0.14
Nodes (12): getConfigColegio(), AppProviders(), PortalLayout(), isTokenValid(), PortalProtectedRoute(), ITEMS, RepresentanteRail(), AlumnoActivoProvider() (+4 more)
...
Cohesion: 0.23
Nodes (8): useIncidentes(), ModalNuevoIncidente(), SkeletonIncidente(), SEVERIDAD_CONFIG, TarjetaIncidente, FILTROS_SEVERIDAD, Incidentes(), INPUT_STYLE
...
Cohesion: 0.06
Nodes (38): getComparacionMateria(), getNotasPlan(), getPlanEvaluacion(), guardarNotasPlan(), guardarPlanEvaluacion(), CONFIGS_ESTADO, ESTADOS_BOTONES, FILA_STYLE (+30 more)
...
Cohesion: 0.21
Nodes (9): useDocenteAlertasRiesgo(), useDocenteHorarioSemana(), useDocenteIncidentes(), useDocenteProgresoNotas(), useDocenteProximasEvaluaciones(), useDocenteRadarCierreLapso(), DocenteDashboard(), DocenteIncidentes() (+1 more)
...
Cohesion: 0.33
Nodes (3): AnularPagoTests, Función C del módulo de Corrección de Pagos (cobranza/correcciones.py)., La unique constraint de Pago excluye estatus='anulado' — un pago         anulad
...
Cohesion: 0.11
Nodes (6): cambiarContrasena(), getAlertasRiesgo(), getMiHorario(), getProximasEvaluaciones(), getRadarCierreLapso(), DocenteCambiarContrasena()
...
Cohesion: 0.09
Nodes (15): aprobarRecarga(), generarLoteTarjetas(), getRecargasPendientes(), getTarjetas(), rechazarRecarga(), ACCIONES, FIELD_STYLE, GenerarLoteModal() (+7 more)
...
Cohesion: 0.12
Nodes (17): actualizarParametrosCantina(), actualizarProducto(), crearCategoria(), crearProducto(), eliminarProducto(), getCategorias(), getParametrosCantina(), getProductos() (+9 more)
...
Cohesion: 0.16
Nodes (16): actualizarItemsMenu(), createMenu(), getConfiguracionSitio(), getMenus(), getMetricasSitio(), getPaginas(), patchConfiguracionSitio(), updatePagina() (+8 more)
...
Cohesion: 0.14
Nodes (14): crearPaginaConSecciones(), crearPreviewPlantilla(), getPlantillasUsuario(), contenidoPorDefecto(), PreviewBloque(), CrearPaginaModal(), inputStyle, SITIO_URL (+6 more)
...
Cohesion: 0.18
Nodes (13): crearPreviewPagina(), createPatronBloque(), createSeccion(), deleteSeccion(), getPatronesBloque(), getSecciones(), reordenarSecciones(), CONFIG_ESTILO_DEFAULT (+5 more)
...
Cohesion: 0.25
Nodes (7): buscarTarjetaParaReponer(), reponerTarjeta(), FIELD_STYLE, IDLE_STYLE, LABEL_STYLE, MOTIVOS, ReponerTarjetaModal()
...
Cohesion: 0.25
Nodes (8): Bloque 2 (completo): Comprobantes.jsx, Pagos.jsx, Bloque 3 (completo): Conciliador.jsx, Reportes.jsx + sus 7 pestañas, Bloque 4 (completo): Inscripciones.jsx, Representantes.jsx, Deuda técnica preexistente encontrada (no introducida por esta migración), Hallazgo previo: primitivas sin commit, MIGRACIÓN VISUAL A PRIMITIVAS COMPARTIDAS (Card/PageHeader/Tabla) — bloques 1-3, Pendiente para bloque 4 en adelante, Verificación estática final (bloques 1-3)
...
Cohesion: 0.15
Nodes (10): Avatar(), EmptyRow(), iniciales(), SectionCard(), SEVERIDAD_PILL, WidgetIncidentes(), WidgetMateriasTabla(), WidgetMensajes() (+2 more)
...
Cohesion: 0.31
Nodes (7): createEventoCalendario(), deleteEventoCalendario(), getEventosCalendario(), useDocenteEventosCalendario(), DIAS_SEMANA, toISODate(), WidgetCalendario()
...
## Knowledge Gaps
- **1006 isolated node(s):** `SERVICES`, `STEPS`, `VALUES`, `deploy.sh script`, `Migration` (+1001 more)
...
- **Why does `StandardResultsPagination` connect `nombreGradoCompleto` to `Cobranza Email Notifications`, `Community 200`, `saveCestaConfig`, `Community 311`, `Community 91`, `Community 349`, `generarReciboSimplePDF`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `apiClient` connect `useBancosCobranza` to `Community 386`, `DatePickerES`, `calcAVEC`, `useAsistencia`, `useAuditoria`, `useBoletin`, `useConciliador`, `useEscape`, `useHorarios`, `useInscripcion`, `useRepresentantes`, `useUsuariosSistemas`, `Comprobantes`, `Community 320`, `calcDefinitiva`, `Community 78`, `Community 84`, `Community 343`, `Community 119`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `ExcelExporter` connect `saveCestaConfig` to `planillaBancaribePDFBytes`, `Community 321`, `Cobranza Email Notifications`, `Community 134`, `Community 200`, `TablaNotas`, `Community 311`, `Community 349`?**
