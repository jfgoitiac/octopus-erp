...
## Corpus Check
- 897 files · ~1,124,030 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6587 nodes · 19280 edges · 480 communities (356 shown, 124 thin omitted)
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 7864 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a317647`
...
## Communities (480 total, 124 thin omitted)
...
Cohesion: 0.08
Nodes (60): actualizarClasificacionLinea(), anularPago(), cargarPagoRetroactivo(), clasificarPagosBatch(), corregirPago(), crearClasificacionPago(), eliminarClasificacionLinea(), getBancos() (+52 more)

### Community 10 - "calcAVEC"
Cohesion: 0.05
Nodes (55): buildCategoriasDefault(), calcAVEC(), calcPrimaAntiguedad(), calcPrimaPostgrado(), calcSueldoBase(), CATEGORIAS_DOCENTE, CESTA_DEFAULT, EMPTY_EMP (+47 more)
...
Cohesion: 0.14
Nodes (111): PdfSinTablaError, El PDF no tiene tablas/texto extraíble (ej. es un escaneo/imagen)., ExcelExporter, Utilidad global para exportar QuerySets a formato Excel (.xlsx) nativo., MensualidadFilter, PagoFilter, Filtros avanzados para el modelo Mensualidad.      Query params disponibles:, Filtros avanzados para el modelo Pago.      Query params disponibles:       - (+103 more)
...
Cohesion: 0.03
Nodes (77): validar_tamano_adjunto(), CuotaSolvenciaAdmin, anular_pago(), cargar_pago_retroactivo(), corregir_pago(), fecha_dentro_periodo_activo(), fecha_en_cierre_validado(), Módulo "Corrección de Pagos".  Tres flujos de negocio relacionados pero distinto (+69 more)

### Community 18 - "useAsistencia"
Cohesion: 0.18
Nodes (4): getDashboardSede(), useSedeDetalle(), MorososList(), SedeDetalle()

### Community 19 - "useAuditoria"
Cohesion: 0.14
Nodes (13): useConsultaInscripcion(), useRepresentantes(), ConsultaInscripcion(), TIPO_INGRESO_LABELS, INPUT_STYLE, Representantes(), ERR_STYLE, INPUT_STYLE (+5 more)

### Community 20 - "useBancosCobranza"
Cohesion: 0.05
Nodes (29): apiClient, failedQueue, activarPortalRepresentante(), desactivarPortalRepresentante(), restablecerContrasenaPortal(), buscarAlumnos(), secretariaService, tokenStore (+21 more)
...
Cohesion: 0.03
Nodes (49): SidebarFichaAlumno(), COLUMNAS, TablaAlumnos(), TablaAlumnosSkeleton(), getBoletin(), exportarMorososExcel(), useBoletin(), useConciliador() (+41 more)
...
Cohesion: 0.06
Nodes (40): ModalAjustarInscripcion(), ModalAjustarMensualidades(), ModalAsignarGrado(), ModalConfirmarQuitarGrado(), ModalConfirmarReactivar(), ESTATUS_FINANCIERO_LABELS, inputStyle, ModalEditarAlumno() (+32 more)
...
Cohesion: 0.10
Nodes (26): actualizar_tasa_bcv_automatica(), Tarea periódica: delega toda la lógica en sincronizar_tasa_con_blindaje., Se ejecuta el día 1 de cada mes (Celery Beat) y crea la mensualidad del mes, Se ejecuta diariamente para sincronizar Alumno.estatus_financiero con el     cr, sincronizar_tasa_con_blindaje(), verificar_solvencia_estudiantil_automatica(), _draw_colegio_header(), generar_pdf_recibo() (+18 more)

### Community 31 - "useInscripcion"
Cohesion: 0.04
Nodes (50): getCuotaInscripcionAlumno(), getMensualidadesAlumno(), sincronizarTasa(), buscarRepresentante(), crearInscripcion(), descargarComprobanteBlob(), fetchAlumnosPorRepresentante(), fetchConfiguracionInscripcion() (+42 more)
...
Cohesion: 0.03
Nodes (67): ProtectedRoute(), FIRST_ACCESSIBLE_ROUTE, getLandingRoute(), ROLE_GROUPS, ROLE_REDIRECT_MAP, ROLES, NotFound, Login() (+59 more)
...
Cohesion: 0.07
Nodes (82): ParametroCantina, Configuración global de cantina — equivalente a cobranza.ParametroGlobal., EsCajeroOAdmin, Cajero de cantina, administrador o director., AjustarCreditoSerializer, AperturaCajaCantinaSerializer, CategoriaProductoSerializer, CierreCajaCantinaSerializer (+74 more)

### Community 55 - "Comprobantes"
Cohesion: 0.07
Nodes (31): BloqueDeudaAlumno(), CobranzaStep1(), CobranzaStep2(), CONCEPTOS, METODOS_PAGO, DecimalInput(), ResumenPago(), useTasaBCV() (+23 more)
...
Cohesion: 0.02
Nodes (32): Retorna True si la nota definitiva es mayor o igual a 10., AperturaCajaCantinaPostTests, CierreCajaCantinaGetTests, CierreCajaCantinaPostTests, Aunque el cliente mande totales falsos, el backend los ignora y recalcula., BancosCantinaYBuscarTarjetaTests, Tests de Fase 3 de cantina: recargas de tarjeta, moneda dual y validación de re, Una referencia ya usada en cobranza.Pago no se puede reutilizar en cantina. (+24 more)
...
Cohesion: 0.05
Nodes (43): CantinaLayout(), NAV_ITEMS, ROL_LABELS, ROLES_CANTINA, ConfirmDeleteModal(), FULL_HEIGHT_PAGES, MainLayout(), PAGE_TITLES (+35 more)

### Community 69 - "Community 69"
Cohesion: 0.18
Nodes (8): useMultiSedeDashboard(), CARDS(), MorososSummary(), SedeCard(), MultiSedeDashboard(), RESUMEN_ITEMS, ResumenGlobal(), fmt()

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (26): Accesibilidad (WCAG 2.1 AA), Auditoría del módulo Inscripciones — 2026-07-02, Auditoría integral 2026-06-13, Auth / ApiClient, Bug crítico corregido (efecto colateral de la auditoría, fuera del módulo), Deuda técnica anotada, no implementada, Deuda técnica anotada, no implementada, Duplicidad / Deuda de código (+18 more)
...
Cohesion: 0.04
Nodes (42): CierreCaja, calcular_desglose_automatico(), ComprobanteSerializer, Reconstruye las líneas reales (mensualidad/inscripción/solvencia/proyecto     d, Solo la factura que generó la solvencia la muestra en reimpresión,         igua, Devuelve el nombre completo del representante.         Primero intenta obtenerl, Los 'hermanos' (pagos de la misma operacion_uuid) se consultan una sola, El primer pago de la operación, con las relaciones M2M de         conceptos (me (+34 more)
...
Cohesion: 0.03
Nodes (62): actualizarDocente(), asignarMateriasDocente(), crearDocente(), createLapso(), createMateria(), deleteHorario(), deleteLapso(), deleteMateria() (+54 more)
...
Cohesion: 0.15
Nodes (9): useDocenteConversaciones(), useDocenteIncidentes(), useDocenteMensajes(), useDocenteMisMaterias(), ChatMensajes(), DocenteIncidentes(), SEVERIDADES, DocenteMaterias() (+1 more)
...
Cohesion: 0.10
Nodes (31): getRendimientoAlumnoPortal(), confirmarResetPassword(), getBancos(), getDashboard(), getHistorial(), getHistorialConsumoCantina(), getReciboPago(), getSaldoTarjetaCantina() (+23 more)
...
Cohesion: 0.29
Nodes (5): actualizarParametrosCantina(), getParametrosCantina(), FIELD_STYLE, LABEL_STYLE, ParametrosCreditoModal()
...
Cohesion: 0.11
Nodes (53): AperturaCajaCantinaAdmin, CategoriaProductoAdmin, CierreCajaCantinaAdmin, DetalleVentaCantinaInline, HistorialCodigoTarjetaAdmin, LoteTarjetasAdmin, MovimientoInventarioAdmin, MovimientoTarjetaAdmin (+45 more)
...
Cohesion: 0.09
Nodes (16): asignarTarjeta(), buscarRepresentantePorCedula(), buscarTarjetaSinAsignar(), generarLoteTarjetas(), getTarjetas(), ACCIONES, AsignarTarjetaModal(), FIELD_STYLE (+8 more)
...
## Knowledge Gaps
- **996 isolated node(s):** `SERVICES`, `STEPS`, `VALUES`, `deploy.sh script`, `Migration` (+991 more)
...
- **Why does `StandardResultsPagination` connect `nombreGradoCompleto` to `Cobranza Email Notifications`, `Community 200`, `saveCestaConfig`, `Community 91`, `Community 349`, `generarReciboSimplePDF`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `apiClient` connect `useBancosCobranza` to `Community 320`, `Community 385`, `Community 386`, `calcDefinitiva`, `DatePickerES`, `calcAVEC`, `Community 78`, `useUsuariosSistemas`, `Community 84`, `Community 119`, `useBoletin`, `Comprobantes`, `useDashboardStats`, `Community 343`, `useInscripcion`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `Modal` connect `useEscape` to `Community 388`, `DatePickerES`, `calcAVEC`, `Community 394`, `Community 402`, `Community 403`, `useBancosCobranza`, `useAuditoria`, `useBoletin`, `Community 409`, `Community 410`, `Community 433`, `Community 314`, `calcDefinitiva`, `Community 326`, `Community 84`, `Community 340`, `Community 89`, `Community 374`, `Community 379`, `Community 382`?**
