...
## Corpus Check
- 891 files · ~1,125,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6553 nodes · 19070 edges · 491 communities (366 shown, 125 thin omitted)
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 7864 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75c8baec`
...
## Communities (491 total, 125 thin omitted)
...
Cohesion: 0.16
Nodes (49): Alumno, BienNacional, ConfiguracionSistema, Inscripcion, AlumnoRetirarSerializer, AsignarGradoSerializer, BienNacionalSerializer, ConfiguracionGradoSerializer (+41 more)

### Community 4 - "Celery Worker Configuration"
Cohesion: 0.13
Nodes (85): AsistenciaFilter, IncidenteFilter, NotaFilter, Filtros avanzados para el modelo Asistencia.      Query params disponibles:, Filtros avanzados para el modelo Nota.      Query params disponibles:       -, Filtros para IncidenteDisciplinario.      Query params disponibles:       - a, AlertaRendimiento, EventoCalendario (+77 more)
...
Cohesion: 0.06
Nodes (44): buildCategoriasDefault(), calcAVEC(), calcPrimaAntiguedad(), calcPrimaPostgrado(), calcSueldoBase(), CESTA_DEFAULT, EMPTY_EMP, EMPTY_RECIBO (+36 more)
...
Cohesion: 0.14
Nodes (106): PdfSinTablaError, El PDF no tiene tablas/texto extraíble (ej. es un escaneo/imagen)., ExcelExporter, Utilidad global para exportar QuerySets a formato Excel (.xlsx) nativo., MensualidadFilter, PagoFilter, Filtros avanzados para el modelo Mensualidad.      Query params disponibles:, Filtros avanzados para el modelo Pago.      Query params disponibles:       - (+98 more)
...
Cohesion: 0.04
Nodes (40): crear_alumno(), Recalcula el estatus con el criterio canónico y lo persiste si cambió.     Usar, sincronizar_estatus_alumno(), alumnos_de_pago(), configuracion_activa(), generar_mensualidades(), mes_en_periodo_lectivo(), meses_ano_escolar() (+32 more)

### Community 18 - "useAsistencia"
Cohesion: 0.24
Nodes (7): useDocenteComparacionMateria(), useDocenteMateriales(), FIELD_STYLE, ModalNuevoMaterial(), DocenteMateriaDetalle(), TAB_IDS, TABS

### Community 20 - "useBancosCobranza"
Cohesion: 0.04
Nodes (33): apiClient, failedQueue, exportarMorososExcel(), getLecturasCircular(), tokenStore, FULL_HEIGHT_PAGES, MainLayout(), PAGE_TITLES (+25 more)
...
Cohesion: 0.06
Nodes (31): SidebarFichaAlumno(), TablaAlumnos(), TablaAlumnosSkeleton(), getBoletin(), buscarAlumnos(), secretariaService, INITIAL_EDIT_FORM, INITIAL_REGISTER_FORM (+23 more)
...
Cohesion: 0.21
Nodes (9): CircularLecturasModal(), CARDS(), MorososSummary(), Cards(), ESTADO_DEFAULT, ESTADO_STYLE, Tabla(), fmt() (+1 more)
...
Cohesion: 0.05
Nodes (59): ModalAjustarInscripcion(), ModalAjustarMensualidades(), ModalAsignarGrado(), ModalConfirmarQuitarGrado(), ModalConfirmarReactivar(), ESTATUS_FINANCIERO_LABELS, inputStyle, ModalEditarAlumno() (+51 more)
...
Cohesion: 0.05
Nodes (35): CuotaSolvenciaAdmin, Meta, Meta, monto_proyecto_inversion_defecto(), Monto base del Proyecto de Inversión desde ParametroGlobal (fallback 0.00 USD)., invalidar_cache_bancos(), Invalida el cache de bancos activos (BancosListView / PortalBancosView)     al, actualizar_tasa_bcv_automatica() (+27 more)
...
Cohesion: 0.03
Nodes (62): ProtectedRoute(), FIRST_ACCESSIBLE_ROUTE, NotFound, Asistencia, Auditoria, Boletin, CantinaCierreCaja, CantinaInventario (+54 more)
...
Cohesion: 0.11
Nodes (115): AperturaCajaCantinaAdmin, CategoriaProductoAdmin, CierreCajaCantinaAdmin, DetalleVentaCantinaInline, HistorialCodigoTarjetaAdmin, LoteTarjetasAdmin, MovimientoInventarioAdmin, MovimientoTarjetaAdmin (+107 more)
...
Cohesion: 0.07
Nodes (27): CantinaLayout(), NAV_ITEMS, ROL_LABELS, ROLES_CANTINA, getLandingRoute(), getRolStyle(), ROL_OPTIONS, ROLE_GROUPS (+19 more)
...
Cohesion: 0.05
Nodes (40): validar_tamano_adjunto(), validar_tamano_adjunto(), Normaliza una referencia bancaria para comparación uniforme:         elimina es, validar_tamano_adjunto(), RegistroNominaAdmin, actualizar_nominas_por_cambio_maestro(), ConceptoNomina, Empleado (+32 more)
...
Cohesion: 0.05
Nodes (40): CierreCaja, CuotaInscripcion, Mensualidad, ComprobanteSerializer, DesglosePagoSerializer, Solo la factura que generó la solvencia la muestra en reimpresión,         igua, Devuelve el nombre completo del representante.         Primero intenta obtenerl, Los 'hermanos' (pagos de la misma operacion_uuid) se consultan una sola (+32 more)
...
Cohesion: 0.06
Nodes (22): actualizarDocente(), asignarMateriasDocente(), crearDocente(), createMateria(), deleteHorario(), deleteMateria(), eliminarDocente(), generarHorario() (+14 more)
...
Cohesion: 0.05
Nodes (35): _buscar_choque_horario(), _docente_tiene_seccion(), _get_rol(), IsAdminOrAbove, IsSecretariaOrAbove, _mensaje_choque_horario(), Permite acceso a director, sistemas y administrador., Permite acceso a secretaria, director, sistemas y administrador. (+27 more)
...
Cohesion: 0.08
Nodes (73): AsistenciaAdmin, BloqueEvaluacionAdmin, BloqueEvaluacionInline, DocenteAdmin, EventoCalendarioAdmin, HorarioClaseAdmin, IncidenteDisciplinarioAdmin, ItemEvaluacionAdmin (+65 more)
...
Cohesion: 0.15
Nodes (12): getCuotaInscripcionAlumno(), getMensualidadesAlumno(), buscarAlumnosPreinscripcion(), descargarPreinscripcionBlob(), descargarPreinscripcionMasivaBlob(), SECCIONES_CAMPOS_PREINSCRIPCION, TODOS_LOS_CAMPOS_PREINSCRIPCION, usePreinscripcion() (+4 more)
...
Cohesion: 0.09
Nodes (21): AlumnoAdmin, RepresentanteAdmin, Representante, AlumnoUpdateSerializer, InscripcionSerializer, Validación preventiva de período de inscripciones y aforo antes de         inic, AlumnoUpdateInfoEndpointReasignarRepresentanteTest, AlumnoUpdateSerializerReasignarRepresentanteTest (+13 more)
...
Cohesion: 0.05
Nodes (26): annotate_en_mora(), _condicion_mora(), Anota `en_mora` (BooleanField) sobre un queryset de Alumno según el criterio, Devuelve (deuda_mes_pasado, deuda_mes_actual, deuda_inscripcion,     deuda_solv, AlumnoListView, buscar_representante_por_cedula(), _cedula_visible(), _eliminar_alumno_definitivo() (+18 more)
...
Cohesion: 0.07
Nodes (23): Revierte DOS pasos de promoción de grado (ej. si un alumno quedó en "4to Año" po, AlumnoManager, AlumnoManagerCompleto, ConfiguracionGrado, Meta, Manager por defecto — solo alumnos activos., Manager alternativo — todos incluyendo retirados., ejecutar_seed() (+15 more)

### Community 311 - "Community 311"
Cohesion: 0.17
Nodes (3): Muestra el estatus financiero EN VIVO cuando el queryset viene anotado, Serializer para gestión CRUD directa de representantes (valida unicidad de cédul, RepresentanteCRUDSerializer
...
Cohesion: 0.09
Nodes (10): BaseCommand, Command, Agrupa retroactivamente pagos históricos que se registraron con varios métodos d, Command, Comando de corrección/backfill de mensualidades.  Uso típico (data ya cargada, Command, Genera el cargo de Solvencia del período indicado para todos los alumnos activo, Command (+2 more)
...
Cohesion: 0.14
Nodes (15): CONFIGS_ESTADO, ESTADOS_BOTONES, FILA_STYLE, FilaAlumno, OBSERV_STYLE, TECLA_A_ESTADO, SkeletonFila(), BACKEND_A_ESTADO (+7 more)
...
Cohesion: 0.18
Nodes (13): createLapso(), deleteLapso(), updateLapso(), useLapsos(), useNotas(), FIELD_STYLE, ModalLapso(), INPUT_STYLE (+5 more)
...
Cohesion: 0.14
Nodes (18): confirmarResetPassword(), getDashboard(), getHistorial(), getHistorialConsumoCantina(), getReciboPago(), getSaldoTarjetaCantina(), solicitarResetPassword(), EstudianteSelector() (+10 more)

### Community 329 - "Community 329"
Cohesion: 0.06
Nodes (11): aplicar_movimiento_inventario(), Único punto de entrada para modificar ProductoCantina.stock_actual.  Cualquier, Aplica un movimiento de inventario bajo lock de fila (select_for_update)     y, aplicar_movimiento_tarjeta(), Aplica un movimiento de saldo sobre `tarjeta` y devuelve el MovimientoTarjeta cr, AplicarMovimientoInventarioTests, AplicarMovimientoTarjetaTests, _parsear_rango_fechas() (+3 more)
...
Cohesion: 0.02
Nodes (37): Retorna True si la nota definitiva es mayor o igual a 10., AperturaCajaCantinaAislamientoTests, AperturaCajaCantinaGetTests, AperturaCajaCantinaPostTests, AperturaCajaCantinaTestsBase, _crear_cajero(), Tests de apertura de caja por cajero — AperturaCajaCantinaView (§ apertura por c, Cierre de caja de UN cajero no debe afectar las sesiones abiertas de     los otr (+29 more)
...
Cohesion: 0.33
Nodes (4): calcular_desglose_automatico(), Reconstruye las líneas reales (mensualidad/inscripción/solvencia/proyecto     d, El primer pago de la operación, con las relaciones M2M de         conceptos (me, Desglosa la operación línea por línea (una por mensualidad/cuota         realme
...
Cohesion: 0.06
Nodes (27): Meta, MovimientoTarjeta, TarjetaPrepago, GeneracionCodigoError, generar_codigo_tarjeta(), _nuevo_token(), Servicio ÚNICO para modificar TarjetaPrepago.saldo, y para generar el token opa, No se pudo generar un `codigo` único tras varios intentos (colisión persistente) (+19 more)
...
Cohesion: 0.50
Nodes (4): AUDITORÍA COMERCIAL — FUNCIONES VENDIDAS VS. ESTADO REAL (2026-08-27), Hallazgos por área, MÓDULO DOCENTE (2026-08-28) — solo anotado, no implementado, Propuesta priorizada (sin implementar — a la espera de tu aprobación)
...
## Knowledge Gaps
- **980 isolated node(s):** `SERVICES`, `STEPS`, `VALUES`, `deploy.sh script`, `Migration` (+975 more)
...
- **Why does `apiClient` connect `useBancosCobranza` to `Community 385`, `Community 386`, `DatePickerES`, `calcAVEC`, `useBoletin`, `useConciliador`, `useDashboardStats`, `useEscape`, `useFocusTrap`, `useInscripcion`, `Community 421`, `useRepresentantes`, `useUsuariosSistemas`, `Comprobantes`, `Community 321`, `calcDefinitiva`, `Community 78`, `Community 84`, `Community 343`, `Community 119`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `StandardResultsPagination` connect `nombreGradoCompleto` to `Community 483`, `Cobranza Email Notifications`, `Community 200`, `saveCestaConfig`, `Community 91`, `generarReciboSimplePDF`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `ExcelExporter` connect `saveCestaConfig` to `Community 483`, `Cobranza Email Notifications`, `Community 134`, `Community 200`, `Community 340`, `TablaNotas`, `Community 344`?**
