...
import { X, Loader2, Paperclip, Megaphone } from 'lucide-react';
...
export default function ModalNuevaCircular({ onClose, onSubmit }) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="modal-circular-titulo"
      tabIndex={-1}
      onClick={e => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="bg-white rounded-2xl p-6 w-full max-w-lg shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-4">
          <h3 id="modal-circular-titulo" className="font-bold flex items-center gap-2" style={{ color: 'var(--jet)' }}>
            <Megaphone size={18} style={{ color: 'var(--pb)' }} />
            Nueva Circular
          </h3>
