...
import { User, Mail, Lock, Eye, EyeOff, UserPlus, Loader2, Check, AlertCircle } from 'lucide-react';
...
const CrearUsuarioModal = ({ onClose, onCreate }) => {
    ...
    const footer = (
        <>
            ...
            <button type="submit" form="form-crear-usuario" disabled={loading || (Object.keys(touched).length > 0 && !canSubmit)}
    ...
    return (
        <Modal
            ...
            size="sm"
        >
            <form id="form-crear-usuario" onSubmit={handleSubmit} className="space-y-4">
